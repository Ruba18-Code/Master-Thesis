...
\newfontfamily\arialbold{TeX Gyre Heros Bold}
\usepackage{helvet}
\usepackage{amsmath}
\usepackage{amsfonts}
\usepackage{ifthen}
...
\usepackage{xcolor}
\usepackage{sectsty}
\chapterfont{\color{azul}\Large}  % sets colour of chapters
\sectionfont{\color{azul}\large}  % sets colour of sections
\subsectionfont{\color{azul}\normalsize}  % sets colour of sections
\subsubsectionfont{\color{azul}\normalsize}  % sets colour of sections
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
