...
\item \textbf{Removal of contaminants from the surface:} Plasma removes contaminants from
    ...
    which leads to higher bonded areas \cite{cho2001,tuli2012}.
\item \textbf{Increase in the number of silanol groups:} 
    Plasma initiates a modification of the surface,
     increasing its number of silanol groups (Si-O-), which are directly correlated to bonding strength \cite{rammhandbook}.
\item \textbf{Improvement of the diffusivity of water and gas trapped at the interface:} 
    ...
    between the two glass substrates during the bonding stage \cite{suniphd}. 
...
$O_2$, $N_2$, and $Ar$ \cite{suniphd,tuli2012}. When operating a plasma cleaner,
...
on the surface and create silanol (Si-OH) groups \cite{yu2023}, which are crucial to start the bonding
...
as \SI{100}{\celsius} \cite{eichler2008,yu2023}.
