...
\item \textbf{Micro-Soap:} Eliminates heavy organic matter and 
        ...
        them easier to remove during rinsing \cite{tuli2012}.
\item \textbf{Acetone:} Effectively dissolves fats, waxes, and 
        photoresists by breaking down organic polymer chains \cite{du2022}.
...
\item \textbf{Piranha Solution:} A mixture of Sulfuric Acid ($H_2SO_4$) and 
        ...
        making it the standard for removing stubborn organic residues. \cite{du2022}
\item \textbf{RCA-1:} A solution of Ammonium Hydroxide, Hydrogen Peroxide, 
        ...
        from the glass surface through electrostatic repulsion \cite{kern1970}.
\item \textbf{RCA-2:} A mixture of Hydrochloric Acid, Hydrogen Peroxide, 
        and water used to eliminate heavy metals and alkaline contaminants \cite{kern1970}.     
\end{itemize}
\end{itemize}
...
silanol groups (Si-OH), which are essential for successful bonding. When 
two surfaces populated with silanol groups are brought into contact, hydrogen bonds 
are established between them \cite{gosele2006, kissinger1990}.
While these bonds do not initially generate 
...
inaccessible to standard chemical soaking \cite{menon1989}.
\begin{figure}[h]
\centering
...
\caption{Bonding process of two Fused Silica surfaces. Initially,
    ...
    stronger covalent bonds through thermal treatment. From \cite{gosele2006}.}
