...
\begin{figure}[h]
    ...
    \caption{Example of the probe of an Atomic Force Microscope. From \cite{wiki_afm_tip}.}
    \label{fig:AFM_tip}
\end{figure}
...
(resonance frequency \SI{320}{\kilo\hertz}, scan rate \SI{0.5}{\hertz}). We examined 
the sample in three different spots of its surface to ensure consistency. The obtained 
data was subsequently analyzed using the \textit{Gwyddion} software, 
through which we obtained the two-dimensional (Figure \ref{fig:AFM_image2D}) 
and three-dimensional (Figure \ref{fig:AFM_image3D}) images. The resulting density 
distribution of roughness is displayed in Figure \ref{fig:roughness_dist}, 
and the detailed list of the surface parameters estimated from our 
