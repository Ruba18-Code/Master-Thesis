...
The water contact angle (WCA) is the standard characterization method 
...
hydroxylated silica surface---with a maximum silanol density of 
approximately \SI{4.6}{\per\nano\meter\squared} \cite{zhuravlev2000}---
therefore exhibits a very high $\gamma_{sg}$ and a low $\gamma_{sl}$, 
resulting in near-zero contact angles. As the silanol density decreases, 
...
\caption{Representative contact angle regimes across different 
    ...
    hydrophobic; surfaces~B, C, and~D are sorted from partially to 
